...
#음악파일들을 music_file_n 변수에 대입
music_file_1 = "Forward.mp3"
music_file_2 = "Right.mp3"
music_file_3 = "Left.mp3"
music_file_4 = "Clockwise.mp3"
music_file_5 = "Anti-clockwise.mp3"
music_file_6 = "Wave.mp3"
...
class gesture:
    ...
    def print_gesture(self):
        ...
        if data==self.GES_RIGHT_FLAG:
            ...
            data=self.paj7620ReadReg(0x43, 1)[0]
            #print("Right")
            pygame.mixer.init(48000, -16, 1, 1024*2)    # mixer를 초기화
            pygame.mixer.music.load(music_file_2)       # 음악 파일을 로드
            pygame.mixer.music.play()                   # 음악 재생

            clock = pygame.time.Clock()                 # clock 변수 선언
            while pygame.mixer.music.get_busy():        # 음악이 실행되는지 확인하는 조건문    
            ...
            #print("Left")
            pygame.mixer.init(48000, -16, 1, 1024*2)    # mixer를 초기화
            pygame.mixer.music.load(music_file_3)       # 음악 파일을 로드
            pygame.mixer.music.play()                   # 음악 재생
            ...
            # print("Forward")
            pygame.mixer.init(48000, -16, 1, 1024*2)    # mixer를 초기화
            pygame.mixer.music.load(music_file_1)       # 음악 파일을 로드
            pygame.mixer.music.play()                   # 음악 재생
            ...
            # print("Clockwise")
            pygame.mixer.init(48000, -16, 1, 1024*2)    # mixer를 초기화
            pygame.mixer.music.load(music_file_5)       # 음악 파일을 로드
            pygame.mixer.music.play()                   # 음악 재생
            ...
            pygame.mixer.init(48000, -16, 1, 1024*2)    # mixer를 초기화
            pygame.mixer.music.load(music_file_4)       # 음악 파일을 로드
            pygame.mixer.music.play()                   # 음악 재생
...
if __name__ == "__main__":
    g=gesture()
    g.init()
    music_file = sys.argv[1]    # sys.argv = 프로그램을 실행할 때 입력된 값을 읽어 들일 수 있는 파이썬 라이브러리
