...
# list에 요소 추가 append : 요소가 마지막 index 뒤로 추가
list_a.append(4)
print(list_a)
list_a.append(5)
print(list_a)
...
# list에 요소 추가 insert : 특정 index의 위치에 요소가 추가
list_a.insert(0, 100)
print(list_a)
list_a.insert(2, 300)
print(list_a)
...
print('------ 요소 삭제 del [2:5] ------')
del list_a[2:5] # index 2,3,4인 요소가 삭제 
print(list_a)
...
chk_2 =  1 in list_a
print('list_a의 요소에 10000이 존재하는가?   ==>  ', chk_1)
print('list_a의 요소에 1이 존재하는가?   ==>  ', chk_2)
