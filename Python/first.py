...
a = 10 
b = 20
nums = [10,40,100,60,30] # list : 여러 자료형을 묶음으로 사용 
names = "python" # 문자열
...
#식별자 주의사항
#키워드, 함수이름, 모듈이름, 클래스이름과 동일하게 사용하면 안된다. 
#   str = 'abc'; # 기존의 str 함수가 변수 str로 변경 : 오류가 아니다. 
